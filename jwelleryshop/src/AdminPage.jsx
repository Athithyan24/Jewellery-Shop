...
const confirmDeleteLoan = async () => {
  ...
  try {
    ...
    await axios.delete(`http://localhost:5000/api/loans/${loanToDelete._id}`, {
      headers: { Authorization: `Bearer ${token}` },
                  ...
                  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col overflow-hidden max-h-[90vh]">
                    <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center shrink-0">
                      <h3 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                        <span className="text-indigo-600"><Store /></span> கடை
                        விவரங்கள் (Edit Shop Profile)
                      </h3>
                      <button
                  ...
                  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-slate-200 flex flex-col max-h-[90vh] overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center shrink-0">
                      <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                        <span className="text-2xl">👤</span> புதிய வாடிக்கையாளர்
                        (Add Customer)
                      </h2>
                      <button
