...
export default function AdminPage() {
  ...
  const confirmDeleteLoan = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      // Important: Axios DELETE requires data to be passed inside a 'data' key
      await axios.delete(
    ...
    <>
      ...
      {userRole === "worker" && currentUser && (
        <div className="relative overflow-hidden bg-slate-50 py-16 px-4 flex items-center justify-center min-h-75">
          ...
          <div className="flex">
            <header className="bg-white border border-slate-200 shadow-sm rounded-xl p-5 sm:p-6 w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              {/* Left Side: Shop Title & Badge */}
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-3">
                  <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
                    {currentUser.username}
                  </h1>
                  <span className="text-[11px] font-bold uppercase tracking-wider text-indigo-700 bg-indigo-50 border border-indigo-100 px-2.5 py-1 rounded-md">
                    {currentUser.shoptype || "Shop"}
                  </span>
                </div>
              </div>

              {/* Right Side: Proprietor Info */}
              {currentUser.username && (
                <div className="flex items-center gap-3 bg-slate-50 border border-slate-100 px-4 py-2.5 rounded-lg shrink-0">
                  <div className="bg-white p-1.5 rounded-md shadow-sm border border-slate-200 flex items-center justify-center">
                    <svg
      ...
      <div className="flex items-center gap-4 px-6 py-3 md:py-0 border-t md:border-t-0 border-slate-100 bg-slate-50 md:bg-transparent">
        ...
        {userRole === "worker" && activeTab === "பரிவர்த்தனைகளின்" && (
          <>
            <div className="flex items-center gap-3 ml-auto">
              <button
                ...
                className="p-3 bg-white border border-slate-200 text-slate-600 rounded-xl hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200 transition-all shadow-sm hover:shadow group flex items-center justify-center">
                <svg
              ...
              <button
                ...
                className="bg-green-500 hover:bg-green-600 cursor-pointer hover: font-bold ml-auto py-2 rounded-lg text-white px-5 items-center content-center justify-center">
                + Add Shop Profile
              </button>
            </div>
          </>
                    ...
                    <div className="bg-emerald-50 border border-emerald-100 p-5 sm:p-6 rounded-2xl shadow-sm flex flex-col justify-between transition-all hover:shadow-md">
                      <div className="mb-4">
                        ...
                        <p className="text-xs text-emerald-600 mt-1 font-medium">
                          காலையில் கடையில் வைத்த தொடக்க இருப்பு (Opening
                          Balance)
                        </p>
                      </div>
                      ...
                      <form
                        ...
                        <button
                          type="submit"
                          className="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-sm transition-all active:scale-95 whitespace-nowrap">
                          சேர் (Add)
                        </button>
                      </form>
                    ...
                    <div className="bg-rose-50 border border-rose-100 p-5 sm:p-6 rounded-2xl shadow-sm flex flex-col justify-between transition-all hover:shadow-md">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <button
                          ...
                          className="bg-rose-600 hover:bg-rose-700 text-white px-8 py-3 rounded-xl font-bold text-sm shadow-sm transition-all active:scale-95 whitespace-nowrap">
                          சேர் (Add)
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    <div className="px-6 py-5 border-b border-slate-100 bg-slate-50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                      <h2 className="text-lg font-black text-slate-800 tracking-wide flex items-center gap-2">
                        <span className="text-indigo-600"><Coffee/></span> தினசரி
                        பரிவர்த்தனைகள் (Daily Ledger)
                      </h2>
                                    ...
                                    stat.expenseDetails.length > 0 ? (
                                      <div className="flex flex-col gap-1.5">
                                        {stat.expenseDetails.map((exp, idx) => (
                                          <div
                                            key={idx}
                                            className="flex justify-between items-center bg-white px-3 py-1.5 rounded-lg border border-slate-200 shadow-sm min-w-[140px] group-hover:border-orange-200 transition-colors">
                              ...
                              return (
                                <tr
                                  ...
                                  <td className="py-3 px-6 whitespace-nowrap text-center">
                                    <button
                                      onClick={() => {
                                        setLoanToDelete(loan); // 'loan' is the current item in your map
                                        setDeleteLoanModal(true);
                                      }}
                                      className="text-rose-500 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 p-2 rounded-lg transition-colors border border-rose-200 shadow-sm"
                                      title="Delete Loan">
                                      <Trash2 />
                                    </button>
                                  </td>
                        ...
                        <tbody className="bg-white divide-y divide-slate-100">
                          {lockerItems && lockerItems.length > 0 ? (
                            ...
                            <tr>
                              ...
                              <td
                                colSpan="7"
                                className="py-12 px-6 text-center content-center justify-center text-slate-500 font-medium">
                                <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            {shopProfile && shopProfile.deletePassword ? (
                              <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5 p-5 bg-rose-50 border border-rose-100 rounded-xl mt-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-[10px] text-slate-400 mt-1">
                                    பழைய கடவுச்சொல்லையே தொடர இதை காலியாக
                                    விடவும்.
                                  </p>
                                </div>
                              </div>
                              ...
                              <div className="md:col-span-2 p-4 bg-indigo-50 border border-indigo-100 rounded-xl mt-2">
                                <label className="block text-xs font-bold text-indigo-700 mb-1 uppercase tracking-wide">
                                  பாதுகாப்பு கடவுச்சொல்லை உருவாக்கவும் (Create
                                  Secret Password)
                                </label>
                                <input
                                  name="deletePassword"
  ...
  <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-in fade-in zoom-in-95 duration-300 print:p-0 print:bg-white print:block">
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl border border-slate-200 print:border-none print:shadow-none print:rounded-none print:w-full print:max-w-none relative flex flex-col max-h-[95vh] print:max-h-none print:block overflow-hidden">
      ...
      <div id="printable-receipt" className="p-8 print:p-0 relative bg-white overflow-y-auto flex-1 print:overflow-visible print:block custom-scrollbar">
          ...
          <div className="text-center mb-6 border-b-2 border-dashed border-slate-300 pb-6 print:border-black flex flex-col items-center">
            {shopProfile?.shopimage ? (
              ...
              <div className="inline-flex items-center justify-center bg-amber-100 text-amber-600 w-12 h-12 rounded-full mb-3 print:hidden shadow-sm">
                <span className="text-2xl"><Landmark /></span>
              </div>
            )}
            
            <h2 className="text-3xl font-black text-slate-800 uppercase tracking-widest print:text-black">
              {shopProfile?.shopName || `${currentUser.username} ${currentUser.shoptype || ''}`}
            </h2>
            ...
            <p className="text-slate-600 font-bold mt-3 text-sm print:text-black max-w-md mx-auto leading-relaxed">
              ...
              <span className="font-mono">Phone: {shopProfile?.phone || "+91 XXXXXXXXXX"}</span>
            </p>
          </div>
              ...
              <div className="space-y-2 text-sm text-slate-700 print:text-black">
                <p className="flex items-center">
                  ...
                  <span className="font-black uppercase text-indigo-700 print:text-black bg-indigo-50 px-2 py-0.5 rounded print:p-0 print:bg-transparent">
                    {selectedLoan.customer?.customerIdy || selectedLoan.customer?.id}
                  </span>
                </p>
                <p className="flex items-center">
                  <span className="font-semibold w-24 text-slate-500 print:text-slate-600">
                      ...
                      <div className="flex flex-col gap-2 mt-4 pt-4 border-t-2 border-dashed border-indigo-200 print:border-black">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-xl font-black text-rose-600 print:text-black">
                            ₹{selectedLoan.currentBalance?.toFixed(2) || (selectedLoan.loanamount - totalPaid).toFixed(2)}
                          </span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div
                    onClick={() => {
                      ...
                      setExportModalOpen(true); // Open password modal
                    }}
